                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="GestionDespachadores" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="editPassword" class="form-label">Clave (Dejar en blanco para mantener la actual)</label>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.editBtn').on('click', function () {
                    // Extraer datos del atributo 'data-*' del botón
                    var id = $(this).data('id');
                    ...
                    $('#editPassword').val(''); // Campo vacío para mantener la contraseña actual
