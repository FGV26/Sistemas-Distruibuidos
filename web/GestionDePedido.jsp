...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                <button id="prev-btn-progress" onclick="prevStep()" class="btn btn-primary">Antes</button>
                <button id="next-btn-progress" onclick="nextStep()" class="btn btn-success">Siguiente</button>
            </div>
        </div>
